...
@section('content')
  ...
  <p class="mb-4">Selamat datang di Vascomm.</p>
  <div class="row">
      <div class="col-xl-8 col-lg-7">
          <div class="card shadow mb-4">
              <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">STATISTIK USER REGISTER</h6>
              </div>
              <div class="card-body">
      ...
      <div class="col-xl-4 col-lg-5">
          <div class="card shadow mb-4">
              <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">STATISTIK PENERIMAAN FRELANCER</h6>
              </div>
              <div class="card-body">
